...
namespace OmokServerLib
{
	ERROR_CODE PacketProcess::GamePut(PacketInfo packetInfo)
	{
		...
		if (endResult == ERROR_CODE::NONE) //게임이 끝나지 않았다면 종료
		{
			...
			SendPacketFunc(packetInfo.SessionIndex, (short)OmokServerLib::PACKET_ID::PUT_STONE_RES, sizeof(resPkt), (char*)&resPkt);
		...
		SendPacketFunc(packetInfo.SessionIndex, (short)OmokServerLib::PACKET_ID::GAME_END_RESULT, sizeof(gameResPkt), (char*)&gameResPkt);
