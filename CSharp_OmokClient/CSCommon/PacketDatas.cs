...
namespace CSCommon
{
    ...
    public class PKTResReadyOmok
    {
        public Int16 Result;
    }

    public class PKTNtfReadyOmok
    {    
        public string UserID;
    ...
    public class PKTNtfStartOmok
    {
        public string FirstUserID; // 선턴 유저 ID
    }

    public class PKTReqPutMok
    {
        public int PosX;
        public int PosY;        
    }

    public class PKTResPutMok
    {
        public Int16 Result;
    }

    public class PKTNtfPutMok
    {
        public int PosX;
        public int PosY;
        public int Mok;
